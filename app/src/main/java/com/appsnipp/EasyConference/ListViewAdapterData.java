...
public class ListViewAdapterData {
    ...
    private int Cnf_id;
    private String Cnf_content;
    private String Cnf_subject;
    private String Cnf_regdate;
    ...
    public String getCnf_content(){return this.Cnf_content;}
    public String getCnf_subject(){return this.Cnf_subject;}
